                        ...
                        <div className="card bg-dark border-0 shadow-lg">
                            <div className="card-body p-5">
                                ...
                                <div className="text-center mb-4">
                                    <Link href="/">
                                        <Image src="/assets/logo.svg" alt="KOI" width={100} height={60} />
                                    </Link>
                                </div>
                                ...
                                {isLogin ? (
                                    <form onSubmit={handleLogin}>
                                        <div className="mb-3">
                                            <label className="form-label text-white-50">邮箱</label>
                                            <input 
                                                type="email" 
                                        ...
                                        <div className="mb-4">
                                            <label className="form-label text-white-50">密码</label>
                                            <input 
                                                type="password" 
                                                className="form-control bg-dark text-white border-secondary"
                                    ...
                                    <form onSubmit={handleRegister}>
                                        <div className="mb-3">
                                            <label className="form-label text-white-50">用户名</label>
                                            <input 
                                                type="text" 
                                                className="form-control bg-dark text-white border-secondary"
                                        ...
                                        <div className="mb-4">
                                            <label className="form-label text-white-50">验证码</label>
                                ...
                                <div className="d-flex align-items-center my-4">
                                    ...
                                    <span className="px-3 text-white-50">或</span>
                                    <hr className="flex-grow-1 text-secondary" />
                                </div>
